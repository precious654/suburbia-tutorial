...
/**
 * Item in *ProductsGrid → Default → Primary → Product*
 */
export interface ProductsGridSliceDefaultPrimaryProductItem {
  /**
   * Skateboard field in *ProductsGrid → Default → Primary → Product*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: products_grid.default.primary.product[].skateboard
...
export interface ProductsGridSliceDefaultPrimary {
  ...
  /**
   * Product field in *ProductsGrid → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: products_grid.default.primary.product[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  product: prismic.GroupField<
    Simplify<ProductsGridSliceDefaultPrimaryProductItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      ProductsGridSlice,
      ProductsGridSliceDefaultPrimaryProductItem,
