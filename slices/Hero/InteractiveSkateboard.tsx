...
function Scene({
  ...
  function onClick(event: ThreeEvent<React.MouseEvent>) {
      ...
      <group ref={originRef}>
        <group ref={containerRef} position={[-0.25, 0, -0.635]}>
          <group position={[0, -0.086, 0.635]}>
            ...
            <HotSpot isVisible={showHotSpot.front} position={[0, 0.38, 1]} color="#994B35" />
            ...
            <HotSpot isVisible={showHotSpot.middle} position={[0, 0.33, 0]} color="#4B7079" />
            ...
            <HotSpot isVisible={showHotSpot.back} position={[0, 0.35, -0.9]} color="#ACF39D" />
